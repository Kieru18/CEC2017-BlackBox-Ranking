...
std::string ApiKeyManager::hashApiKey(const std::string& apiKey) {
...
std::string ApiKeyManager::generateRandomApiKey(int length) {
...
void ApiKeyManager::sendApiKey(const std::string& recipentAddress, const std::string& apiKey) {
