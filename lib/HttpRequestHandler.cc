...
std::string HttpRequestHandler::generateHTTPResponse(const std::string& textResponse) {
...
void HttpRequestHandler::handleClient(std::shared_ptr<boost::asio::ip::tcp::socket> socket) {
    try {
